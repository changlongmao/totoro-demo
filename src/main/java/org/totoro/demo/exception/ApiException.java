package org.totoro.demo.exception;


import org.totoro.common.exception.BaseException;
...
public class ApiException extends BaseException {
    ...
    public ApiException(String errCode, Object... args) {
        super(errCode, StringUtil.isEmpty(getErrorInfo(errCode)) ? String.valueOf(args[0]) : String.format(getErrorInfo(errCode), args));
    }
    ...
    public static class ApiResultUtil {
        ...
        static {
            try (InputStream inputStream = CommonApiException.ApiResultUtil.class.getClassLoader().getResourceAsStream("api-error.properties");){
                p.load(inputStream);
            } catch (IOException e) {
